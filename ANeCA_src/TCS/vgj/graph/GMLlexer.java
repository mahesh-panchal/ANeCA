...
*/
/*
This file is a simple modification of the GMLlexer class
to help with deprecated code and so I don't break TCS again
*/
...
public class GMLlexer{
	  ...
	  public GMLlexer(Reader streamin){
		 stream_ = streamin;
	  }
	  ...
	  public int nextToken() throws java.io.IOException
	  {
		 ...
		 else if(nextChar_ == '-' || (nextChar_ >= '0' && nextChar_ <= '9'))
		 {
			...
			if(nextChar_ == '-')
			{
			   isneg = true;
			   nextChar_ = stream_.read();
			   boolean _tmp = (nextChar_ < '0' || nextChar_ > '9');
