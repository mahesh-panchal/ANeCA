...
public class pictdialog extends JDialog implements ActionListener
{
	...
	public pictdialog(JFrame frame, GraphCanvas graph_canvas)
	{
		super(frame, "PICT Format Output", true);
		...
		landscape_.addActionListener(this);
